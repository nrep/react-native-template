...
import { Button, ButtonGroup, Divider, Icon, Layout, Text, useTheme, Calendar, RangeCalendar,  } from '@ui-kitten/components';
...
export const Report = ({ navigation, since, until }) => {
...
export const FixedReport = ({ navigation , since = today, until = today}) => <Report since={since} until={until} navigation={navigation}/>

export const CustomReport = ({ navigation }) => {
    ...
    return (
        <>
            ...
            {isDatePicked && since && (
                <Report since={since} until={until} navigation={navigation} />
            )}
        </>
    );
}